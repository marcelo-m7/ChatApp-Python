import os
import json
from assistants.utils.paths import WEB_SCRAPER_JSON_DIR
...
def get_vector_store(
        json_folder=str(WEB_SCRAPER_JSON_DIR)) -> VectorStore:
    """
    ...
    - json_folder (str, optional): The folder containing JSON files to be used for building the vector store.
      Defaults to the repository path `src/assistants/data/knowledge/flet/__extracted_code`.
